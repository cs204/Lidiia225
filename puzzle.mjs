...
// Б ни чего не сказал.
let знания1 = new И()
знания1.добавить(new Эквивалентность(new Или(АЛжец, БЛжец), БРыцарь));
...
// В сказал: "А - рыцарь."
let знания3 = new И()
знания3.добавить(new Эквивалентность(new И(АЛжец, БЛжец), БРыцарь));
знания3.добавить(new Эквивалентность(new Или(БЛжец, ВЛжец), ВРыцарь));
